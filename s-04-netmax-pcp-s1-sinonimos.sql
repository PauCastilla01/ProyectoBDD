...
--@Descripción: Creación de sinónimos para pcpbdd_s1
...
create or replace synonym USUARIO_F5 for USUARIO_F5_PCP_S2;
create or replace synonym TIPO_SERIE_R1 for TIPO_SERIE_R_PCP_S2;
create or replace synonym TIPO_CUENTA_R1 for TIPO_CUENTA_R_PCP_S2;
create or replace synonym PAIS_R1 for PAIS_R_PCP_S2;
